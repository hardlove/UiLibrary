...
public class NavigationBarPlaceholderView extends View {
    ...
    private static final String STATUS_BAR_HEIGHT_KEY = "navigation_bar_height_key";
    ...
    public NavigationBarPlaceholderView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ...
        if (statusBarHeight == 0) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if (windowInsets != null) {
                    statusBarHeight = windowInsets.getInsets(WindowInsetsCompat.Type.navigationBars()).top;
                    if (statusBarHeight > 0) {
